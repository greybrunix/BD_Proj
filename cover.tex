...
\backgroundsetup{
    ...
    contents={
        \begin{tikzpicture}[remember picture,overlay]
            ...
            \node[color=white] at ($(current page.south west) + (3,4)$) {\bfseries {\fontsize{120}{60} \textsf{B}}};
...
%% TITLE
\title{O Estranho Caso dos Eventos de NeoLivropolis}

%% AUTHORS
\author{
    Bruno Gi\~ao %%%$($a$96544)$%%% Bruno Dias da Gião
  \quad
    Jo\~ao Pereira %%%$($a$95375)$%%% João Luís da Cruz Pereira
  \quad
    Maria Salazar %%% $($a$95375)$%%% Maria Helena Alves Machado Marques Salazar
  \quad
    Tiago Teixeira %%% $($a$95375)$%%% Tiago Emanuel Lemos Teixeira
}
%% Date
